...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (Schema::hasTable('grbmut')) {
            Schema::table('grbmut', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('grbmut');
        Schema::dropIfExists('staging_grbmut');
    }
};
