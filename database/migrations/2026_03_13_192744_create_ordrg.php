...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (Schema::hasTable('ordrg')) {
            Schema::table('ordrg', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('ordrg');
        Schema::dropIfExists('staging_ordrg');
    }
};
