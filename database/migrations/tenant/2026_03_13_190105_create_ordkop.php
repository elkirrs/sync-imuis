...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (Schema::hasTable('ordkop')) {
            Schema::table('ordkop', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('ordkop');
        Schema::dropIfExists('staging_ordkop');
    }
};
