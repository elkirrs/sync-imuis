...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (Schema::hasTable('debopp')) {
            Schema::table('debopp', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('debopp');
        Schema::dropIfExists('staging_debopp');
    }
};
