...
return new class extends Migration
{
    ...
    {
        $tables = ['selcode', 'staging_selcode'];
        ...
        if (Schema::hasTable('selcode')) {
            Schema::table('selcode', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('selcode');
        Schema::dropIfExists('staging_selcode');
    }
};
