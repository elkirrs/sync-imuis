 ...
 *   https://datatables.net/download/#bs5-5.3.0/jq-3.7.0/dt-2.1.3/af-2.7.0/b-3.1.1/b-colvis-3.1.1/b-print-3.1.1/cr-2.0.3/date-1.5.3/fc-5.0.1/fh-4.0.1/kt-2.12.1/r-3.0.2/rg-1.5.0/rr-1.5.0/sc-2.4.3/sb-1.7.1/sp-2.3.1/sl-2.0.4/sr-1.4.1
 *
 * Included libraries:
 *   Bootstrap 5 5.3.0, jQuery 3 3.7.0, DataTables 2.1.3, AutoFill 2.7.0, Buttons 3.1.1, Column visibility 3.1.1, Print view 3.1.1, ColReorder 2.0.3, DateTime 1.5.3, FixedColumns 5.0.1, FixedHeader 4.0.1, KeyTable 2.12.1, Responsive 3.0.2, RowGroup 1.5.0, RowReorder 1.5.0, Scroller 2.4.3, SearchBuilder 1.7.1, SearchPanes 2.3.1, Select 2.0.4, StateRestore 1.4.1
 */
